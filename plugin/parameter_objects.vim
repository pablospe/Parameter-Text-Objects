...
"
"    vmap     <silent> i; <Plug>ParameterObjectI2
"    omap     <silent> i; <Plug>ParameterObjectI2
"    vmap     <silent> a; <Plug>ParameterObjectA2
"    omap     <silent> a; <Plug>ParameterObjectA2
"
...
vnoremap <silent> <script> <Plug>ParameterObjectI2 :<C-U>call <SID>parameter_object("i", ';')<cr>
onoremap <silent> <script> <Plug>ParameterObjectI2 :call <SID>parameter_object("i", ';')<cr>
vnoremap <silent> <script> <Plug>ParameterObjectA2 :<C-U>call <SID>parameter_object("a", ';')<cr>
onoremap <silent> <script> <Plug>ParameterObjectA2 :call <SID>parameter_object("a", ';')<cr>

function s:parameter_object(mode, ch)
   let ve_save = &ve
  ...
  try
    ...
    if searchpair('(',a:ch,')', 'bWs', "s:skip()") <= 0
      return
    endif
    ...
    if a:mode == "a" && @l == a:ch && !exists("gotone")
    else
        normal! h
    endif
    normal! v`l
